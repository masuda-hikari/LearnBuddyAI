...
| **Basic** | ¥980/月 | 1日20質問、広告なし、基本進捗分析 |
| **Premium** | ¥2,980/月 | 1日50質問、全レッスン、詳細進捗分析、優先サポート |
| **Pro** | ¥9,800/月 | 無制限質問、全機能、API連携、専用サポート |
...
|---------|-----------|--------|------|--------|
| 市場データ | EdTech市場、オンライン学習、AIチューター | 調査レポート | 月1回 | data/collected/market/ |
| 競合情報 | Duolingo, Khan Academy, Coursera, Quizlet, スタディサプリ | 競合サイト | 週1回 | data/collected/competitor/ |
| 技術動向 | Spaced Repetition, Adaptive Learning, LLM Education | GitHub、公式ドキュメント | 週1回 | data/collected/tech/ |
| SNSトレンド | #英語学習 #AIチューター #EdTech #語学学習 | X/Twitter | 日1回 | data/collected/social/ |
| 法規制 | 教育サービス規制、未成年者保護、個人情報保護法 | 官公庁サイト | 月1回 | data/collected/legal/ |
...
|-----------------|-----------|------|------|
| X/Twitter | @LearnBuddyAI | 学習Tips・英語語彙コンテンツ配信 | 要開設 |

### 投稿スケジュール
| 曜日 | 時間 | コンテンツタイプ |
|------|------|-----------------|
| 月-金 | 09:00, 18:00 | 価値提供投稿（Word of the Day、学習Tips） |
| 土日 | 12:00 | 週間まとめ |
